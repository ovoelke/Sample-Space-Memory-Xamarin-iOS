...
extern void *mono_aot_module_SpaceMemory_iOS_info;
...
extern void *mono_aot_module_SpaceMemory_Core_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_SpaceMemory_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_SpaceMemory_Core_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "SpaceMemory.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
